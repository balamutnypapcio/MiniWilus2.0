...
(library Library_1
	...
	(compDef "LM74700QDBVRQ1" (originalName "LM74700QDBVRQ1") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "VCAP") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "6" (pinName "ANODE") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "GATE") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "CATHODE") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/LM74700-Q1")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "LM74700QDBVRQ1.stp")
